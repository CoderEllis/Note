...
class ScanQRCodeVC: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate, AVCaptureMetadataOutputObjectsDelegate, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    lazy var flashlightBtn: UIButton = {
        ...
        let bundlePath = Bundle(path: Bundle.main.path(forResource: "resource", ofType: "bundle")!)
...
//        self.title = "扫一扫"
    ...
    func createScanBackgroundView(scanWidth: CGFloat) {
        ...
        let image = UIImage.init(named: "ticket_scan_border.png", in: Bundle(path: Bundle.main.path(forResource: "resource", ofType: "bundle")!), compatibleWith: nil)
        ...
        scanLine.image = UIImage.init(named: "qrcode_scan_light_green.png", in: Bundle(path: Bundle.main.path(forResource: "resource", ofType: "bundle")!), compatibleWith: nil)
        ...
        let codeY: CGFloat = (height + scanWidth + 20 + codeH)/2 + 10
...
extension ScanQRCodeVC {
    ...
    func scanSound() {
        ...
        let soundFile = Bundle.main.path(forResource: "resource.bundle/scanSound", ofType: "mp3")
