...
/**
 * Should show value string 显示数值
 */
@property (nonatomic,assign) IBInspectable BOOL      showValueString;

/**
 * The value of the progress bar  //进度值
 */
...
/** 
 * The color of the progress bar  进度条已完成颜色
 */
@property (nonatomic,strong) IBInspectable UIColor   *progressColor;

/**
 * The color of the progress bar frame  进度条外部颜色
 */
...
/**
 * The color of the background bar  进度条未完成颜色
 */
